 ...
 * @author X-rapido
 */
public class RadomGenerateData {
	...
	public static String getTelphone() {
		int index=getNum(0,quhao.length-1);
		String first=quhao[index];
		return (first+"-"+10000000+(int)(Math.random()*90000000))+"";
	}
	 ...
	 *   
	 */
	private static String[] platform="ios,android".split(",");
	public static String getPlatform(){
		int idx=getNum(0,1);
		return platform[idx];
	}
	
	private static String[] typerelation="callhistory,contactlist".split(",");
	public static String getType(){
		int idx=getNum(0,1);
		return typerelation[idx];
	}
	 ...
	 * 返回手机号码
	 */
	private static String[] telFirst="188,189,186,134,135,136,137,138,139,150,151,152,157,158,159,130,131,132,155,156,133,153".split(",");
