...
public class ExportBlackOrderToCSVLevel1 {
...
//		QueryApplyByApplyLevel1("ApplyInfo",argString[0].replace('_', '|'),"/home/graphdb/batchimporthandle/apply/applyexportdata/callcontactlevel2/"+argString[1]+".csv");
		System.out.println(" DoTagOrders.BlackOrderNoList.size:"+ DoTagOrders.BlackOrderNoList.size());
		for (String orderno : DoTagOrders.BlackOrderNoList) {
			QueryApplyByApplyLevel1("ApplyInfo",orderno,argString[0].replace('_', '|'),"/home/graphdb/batchimporthandle/apply/exportblackorder1/alllevel1.csv");
		}
	}
	
	
	public static void QueryApplyByApplyLevel1(String modelname,String orderno,String relation,String filepath) {
		//192.168.0.247
		Connection con =null;
		Statement stmt =null;
		ResultSet rs =null;
...
//			String sql="match (n:"+modelname+" {orderno:'"+orderno+"'})-[r:"+relation+"]-(p)-[r1:"+relation+"]-(m:ApplyInfo)-[r2:"+relation+"]-(q)-[r3:"+relation+"]-(w:ApplyInfo) return n.orderno,r,p.content,r1,m.orderno,r2,q.content,r3,w.orderno";
//			String sql="match (n:"+modelname+" {tag:'black'})-[r:"+relation+"]-(p)-[r1:"+relation+"]-(m:ApplyInfo) return n.orderno,r,p.content,r1,m.orderno";
			String sql="match (n:"+modelname+" {orderno:'"+orderno+"'})-[r:"+relation+"]-(p)-[r1:"+relation+"]-(m:ApplyInfo) return n.orderno,r,p.content,r1,m.orderno";
