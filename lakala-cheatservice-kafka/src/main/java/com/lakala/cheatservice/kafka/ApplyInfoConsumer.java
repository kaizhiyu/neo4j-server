package com.lakala.cheatservice.kafka;
		...
		while (it.hasNext())
		{
		    ...
		    if(logSession.getLogNo()!=null&&!logSession.getLogNo().equals("")){
				...
				if(logNoString.equals("generalApply_CreditLoan")){
					...
					Map<String,Object> mapsSources= logSession.getFlatMap();
					Map<String,Object> maps= new HashMap<String, Object>();
					for(Map.Entry<String, Object> map:mapsSources.entrySet()){
						maps.put(map.getKey().toLowerCase(), map.getValue());
					}
					...
					if (!orderno.equals("")) {
						...
						if(maps.get("mobile")!=null&&StringUtils.isNotEmpty(maps.get("mobile").toString())){
							mobileSet.add(maps.get("mobile").toString());//紧急联系人
						}
						if(maps.get("usermobile")!=null&&StringUtils.isNotEmpty(maps.get("usermobile").toString())){
							mobileSet.add(maps.get("usermobile").toString());//紧急联系人
						}
						if(maps.get("certno")!=null&&StringUtils.isNotEmpty(maps.get("certno").toString())){
							mobileSet.add(maps.get("certno").toString());//紧急联系人
						}
						...
						if(maps.get("debitbank")!=null&&StringUtils.isNotEmpty(maps.get("debitbank").toString())){
							mobileSet.add(maps.get("debitbank").toString());//紧急联系人
						}
						if(maps.get("termid")!=null&&StringUtils.isNotEmpty(maps.get("termid").toString())){
							mobileSet.add(maps.get("termid").toString());//紧急联系人
						}
						if(maps.get("email")!=null&&StringUtils.isNotEmpty(maps.get("email").toString())){
							mobileSet.add(maps.get("email").toString());//紧急联系人
						}
						if(maps.get("creditbank")!=null&&StringUtils.isNotEmpty(maps.get("creditbank").toString())){
							mobileSet.add(maps.get("creditbank").toString());//紧急联系人
						}
						if(maps.get("ipv4")!=null&&StringUtils.isNotEmpty(maps.get("ipv4").toString())){
							mobileSet.add(maps.get("ipv4").toString());//紧急联系人
						}
						if(maps.get("usercoremobile")!=null&&StringUtils.isNotEmpty(maps.get("usercoremobile").toString())){
							mobileSet.add(maps.get("usercoremobile").toString());//紧急联系人
						}
						if(maps.get("_deviceid")!=null&&StringUtils.isNotEmpty(maps.get("_deviceid").toString())){
							mobileSet.add(maps.get("_deviceid").toString());//紧急联系人
						}
						if(maps.get("companyname")!=null&&StringUtils.isNotEmpty(maps.get("companyname").toString())){
							mobileSet.add(maps.get("companyname").toString());//紧急联系人
						}
						if(maps.get("companyaddress")!=null&&StringUtils.isNotEmpty(maps.get("companyaddress").toString())){
							mobileSet.add(maps.get("companyaddress").toString());//紧急联系人
						}
						if(maps.get("companytel")!=null&&StringUtils.isNotEmpty(maps.get("companytel").toString())){
							mobileSet.add(maps.get("companytel").toString());//紧急联系人
						}
						if(maps.get("merchantmobile")!=null&&StringUtils.isNotEmpty(maps.get("merchantmobile").toString())){
							mobileSet.add(maps.get("merchantmobile").toString());//紧急联系人
						}
...
//						SaveApplyInfoHbase(mobile, mobileSet,maps);//保存hbase
						...
						SaveApplyInfoNeo4j(orderno,maps);
					}
...
//						SaveMobileHbase(collectData.getLoginName(),contactMobileList, DataTypeEnum.CONTACT_LIST);
	 ...
	 * 2.set去掉hbase已有的关系
	 * 3.创建新的关系
	 * @author guozhijie 2016年12月26日 上午11:03:22
	 * @since 1.0.0.000
	 * @param mobile
	 * @param set
	 * @param _deviceid
	 ...
	 * 功能描述
	 * 创建手机号实体
	 * @author guozhijie 2016年12月26日 上午11:10:28
	 * @since 1.0.0.000
	 * @param mobile
	 * @param set
	 * @param _deviceid
	 * @return
	 */
	public void SaveApplyInfoNeo4j(String orderno,Map<String,Object> maps){
		...
		for(Map.Entry<String, Object> map:maps.entrySet()){
			...
			case "contactmobile":
				if(valueString!=null&&!"".equals(valueString))
				{
					sbApply.append("m.contact_mobile='"+(map.getValue()==null?null:map.getValue().toString())+"',");
			...
			case "certno":
				if(valueString!=null&&!"".equals(valueString))
				{
					sbApply.append("m.cert_no='"+(map.getValue()==null?null:map.getValue().toString())+"',");
			...
			case "_deviceid":
				if(valueString!=null&&!"".equals(valueString))
				{
					sbApply.append("m.device_id='"+(map.getValue()==null?null:map.getValue().toString())+"',");
...
//				break;
			case "companyname":
				if(valueString!=null&&!"".equals(valueString))
				{
					sbApply.append("m.company='"+(map.getValue()==null?null:map.getValue().toString())+"',");
			...
			case "companyaddress":
				if(valueString!=null&&!"".equals(valueString))
				{
					sbApply.append("m.comp_addr='"+(map.getValue()==null?null:map.getValue().toString())+"',");
			...
			case "companytel":
				if(valueString!=null&&!"".equals(valueString))
				{
					sbApply.append("m.comp_phone='"+(map.getValue()==null?null:map.getValue().toString()).replace("|", "")+"',");
		...
		String applyCypher=sbApply.toString().trim();
		int endsub=applyCypher.length()-1;
		String applysql=applyCypher.substring(0, endsub);//�����һ������ȥ��
